    ...
    for i=1:nColors
        ...
        if backgrounds{1,i} == 1
            ...
            if corrections==1
                ...
                scribble_mean_matrix(positions,1,:) = ones(length(positions),1,3).*scribble_means(i, 1,:);
                scribble_var_matrix(positions,1,:) = ones(length(positions),1,3).*scribble_vars(i, 1,:);
            end
        end
    end
